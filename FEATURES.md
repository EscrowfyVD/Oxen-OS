# Oxen OS — Documentation fonctionnelle

> Document généré le 2026-05-01. Version 1.0.
> Maintenu par Vernon Dessy. À régénérer tous les 3 mois ou après major sprint.
> Audience : Vernon (Founder/CEO), équipe PM, Andy (Head of Sales).
...
## Pour Andy — Modules Sales/Marketing/CRM

> Cette section liste uniquement les modules qu'Andy et l'équipe sales/marketing utilisent au quotidien. Pour la vue complète, voir [Pour le PM](#pour-le-pm--vue-complète).

**Modules core** :
- [1. Dashboard](#1-dashboard) — vue d'ensemble matinale
- [2. CRM](#2-crm) — pipeline, contacts, companies, outreach, reports (le module le plus utilisé)
- [3. Marketing](#3-marketing) — Social Media, Content, SEO/GEO, Veille, Compliance Check
- [6. Sentinel](#6-sentinel) — AI assistant pour préparer meetings et générer briefs
- [7. Calendar](#7-calendar) — meetings de l'équipe + call notes
- [8. Tasks](#8-tasks) — tâches assignées (vue My Tasks)
- [9. Intel](#9-intel) — veille AI competitors / marketing
- [10. Conferences](#10-conferences) — events professionnels + ROI
- [15. Wiki](#15-wiki) — documentation interne (lecture)

**Reports clés** :
- [CRM Reports](#sub-module-26--reports-crmreports) — pipeline, revenue, performance par owner
- [Marketing Compliance Check](#sub-module-35--compliance-check-tab-compliance) — validation pré-publication

**Workflows critiques** :
- Acquisition lead → CRM Contacts → AI scoring → Push Lemlist → Pipeline
- Préparer meeting → Sentinel Brief → Call Notes → Post-meeting CRM update
- Détecter conférence (Intel) → Accept → Conferences → Rapport post-event

---

## Pour le PM — Vue complète

> Cette section liste **tous** les modules d'Oxen OS, dans l'ordre d'importance pour pilotage produit.

**Modules core métier (Sales/Marketing)** :
- [1. Dashboard](#1-dashboard)
- [2. CRM](#2-crm) — 6 sub-modules
- [3. Marketing](#3-marketing) — 5 sub-modules (avec SEO/GEO mini-module à 6 sub-tabs)
- [9. Intel](#9-intel) — 7 catégories AI-powered
- [10. Conferences](#10-conferences) — 3 sub-modules
- [6. Sentinel](#6-sentinel) — 3 sub-modules + cross-module surface

**Modules ops & finance** :
- [4. Finance](#4-finance) — 5 sub-modules
- [5. Compliance](#5-compliance) — 6 sub-modules
- [11. Support](#11-support) — 3 sub-modules

**Modules équipe & internal** :
- [7. Calendar](#7-calendar)
- [8. Tasks](#8-tasks) — 3 vues
- [14. Team](#14-team)
- [16. Absences](#16-absences) — 4 sub-modules
- [13. Organigramme](#13-organigramme)
- [15. Wiki](#15-wiki) — 2 sub-modules
- [12. Settings](#12-settings) — 2 sub-modules (super_admin only pour Roles)

**Architecture transverse** :
- [T1-T8 transverses](#architecture-transverse) — webhooks, workers, auth, AI cross-module, telegram, drive, email, jobs

**Lectures recommandées en jour 1** :
1. Ce doc en entier (45 min)
2. `ARCHITECTURE.md` (stack tech)
3. `MIGRATIONS.md` (DB)
4. Les 13 `SPRINT_X_REPORT.md` (log des sprints récents)
5. `prisma/schema.prisma` (70 models)
