...
import {
  ...
  SECTOR_COLORS, STATUS_COLORS, STATUSES, INTERACTION_TYPES, INTERACTION_ICONS,
  labelStyle,
} from "@/components/crm/constants"
import type { Contact, Interaction, Employee } from "@/components/crm/types"
    ...
    <div style={{ flex: fullWidth ? "1 1 100%" : "1 1 45%", minWidth: 0 }}>
      ...
      {editingField === field ? (
        ...
        <div
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.borderBottomColor = "rgba(192,139,136,0.3)"
          }}
          onMouseLeave={(e) => {
  ...
  if (!contact) {
    return (
      <div style={{ padding: "60px 32px", textAlign: "center", color: TEXT_TERTIARY }}>
        Contact not found.{" "}
        <span
          style={{ color: ROSE_GOLD, cursor: "pointer" }}
